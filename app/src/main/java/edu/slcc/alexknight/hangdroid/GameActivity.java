...
public class GameActivity extends AppCompatActivity implements AddLetterDialogFragment.NoticeDialogListener {
    ...
    private void clearScreen() {
        ...
        TextView textView = (TextView) findViewById(R.id.textViewWrong);
        textView.setText(getResources().getString(R.string.guessedletters));
